...
with open('static/models/cook_book_v4.pkl', 'rb') as f:
    cook_book_v4 = pickle.load(f)
...
@app.route('/')
def home():
    cook_book_json=json.dumps(cook_book_v4)
    cook_book_json = json.loads(cook_book_json)
    return render_template('home.html', ingred_list=ingred_list, cook_book_v2=cook_book_v4, cuisines=cuisines, cook_book_json=cook_book_json)
